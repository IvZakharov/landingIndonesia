        ...
        <div className={"md:flex md:gap-8 xl:gap-28"}>
          ...
          <div className={"md:flex flex-col"}>
            <p className={"text md:text-justify text-white italic mb-8"}>
              Tекущая ситуация в мировой экономике оказывает пагубное влияние на
              ...
              оптимизации бизнес-процессов. Наша команда поможет создать
              надёжную инфраструктуру для вашего бизнеса.
            </p>
            ...
            >
              ...
              позицию для предпринимателей со всего мира. А возможность
              обменивать криптовалюту на фиатные деньги без получения
              дорогостоящей лицензии способствует привлечению крупных инвестиций
              и созданию новых финансовых продуктов.
            </p>
