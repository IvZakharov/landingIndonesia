      ...
      <div className={"container relative"}>
        <div className={"md:flex md:gap-8 xl:gap-28"}>
          ...
          <div className={"md:flex flex-col"}>
            ...
            <p className={"text md:text-justify text-white italic mb-8"}>
              Наша команда проконсультирует вас по вопросам индонезийского
              законодательства, окажет помощь в открытии компаний, банковских
              счетов и юридическом сопровождении бизнеса. Все сотрудники
              обладают большим опытом работы, знанием страны, её традиций и
              пониманием местного менталитета. Мы работаем в тесном контакте с
              банками, государственными учреждениями, некоммерческими
              организациями с 2017 года и готовы обсудить с вами любые идеи
              связанные с ведением бизнеса в Индонезии, получением финансовых
              лицензий или релокации.
            </p>
